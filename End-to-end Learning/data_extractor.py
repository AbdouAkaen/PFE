...
"""
 *  The class Features is used to read and seperate various parameters from the 
 * csv file and return them as arrays for the train process.
 * @ param Gets the dataset directory path.
 """
class Features(Dataset):
    """
    *  Initializes the parameters in the Features class.
    ...
    * @return None. 
    ...
    """
    *  Function to load the csv file and seperate the values written in them.
    ...
    * @return The split and extracted consolidated data.
    ...
    """
    *  Function to test the return of csv data
    * @param None.
    * @return The csv data
    """ 
    ...
    * @return The length of the dataset.
    ...
    """
    *  Function to return one data point from the csv file.
